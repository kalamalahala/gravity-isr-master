...
function displayCumulativeData( dataSet, skippedAgents ) {
    ...
    for (i = 0; i < dataSet.length; i++) {
        ...
        var RefAPToAdd = isNaN( parseFloat( dataSet[i].refAP ).toFixed( 2 ) ) ?
                         0 :
        ...
        jQuery( '#main-agent-stats-cumulative-table' ).append( '<tr class="cummulative-row">'
                                                               +
                                                               ...
                                                               + (dataSet[i].AP / dataSet[i].appts).toFixed( 2 )
                                                                                                   .toString()
                                                               ...
                                                               '<td class="cumulative-data"><span>'
                                                               + (dataSet[i].pres * 100 / dataSet[i].appts).toFixed( 2 )
                                                                                                           .toString()
                                                               + '%</span><span class="datum-test-val">'
                                                               + (dataSet[i].pres * 100 / dataSet[i].appts).toFixed( 2 )
                                                                                                           .toString()
                                                               ...
                                                               '<td class="cumulative-data"><span>'
                                                               + (dataSet[i].sales * 100 / dataSet[i].pres).toFixed( 2 )
                                                                                                           .toString()
                                                               + '%</span><span class="datum-test-val">'
                                                               + (dataSet[i].sales * 100 / dataSet[i].pres).toFixed( 2 )
                                                                                                           .toString()
                                                               ...
                                                               '<td class="cumulative-data"><span>'
                                                               + (dataSet[i].apptsref * 100 / dataSet[i].appts).toFixed(
                2 ).toString()
                                                               + '%</span><span class="datum-test-val">'
                                                               + (dataSet[i].apptsref * 100 / dataSet[i].appts).toFixed(
                2 ).toString()
                                                               ...
                                                               + (dataSet[i].refpres
                                                                  * 100
                                                                  / dataSet[i].pres).toFixed( 2 ).toString()
                                                               + '%</span><span class="datum-test-val">'
                                                               + (dataSet[i].refpres
                                                                  * 100
                                                                  / dataSet[i].pres).toFixed( 2 ).toString()
                                                               ...
                                                               '<td class="cumulative-data"><span>'
                                                               + (dataSet[i].refAP * 100 / dataSet[i].AP).toFixed( 2 )
                                                                                                         .toString()
                                                               + '%</span><span class="datum-test-val">'
                                                               + (dataSet[i].refAP * 100 / dataSet[i].AP).toFixed( 2 )
                                                                                                         .toString()
                                                               ...
                                                               + (dataSet[i].refsales
                                                                  * 100
                                                                  / dataSet[i].refpres).toFixed( 2 ).toString()
                                                               + '%</span><span class="datum-test-val">'
                                                               + (dataSet[i].refsales
                                                                  * 100
                                                                  / dataSet[i].refpres).toFixed( 2 ).toString()
